...
const loadBalance = parseBool(inArg.loadbalance) || false,
    ...
    fallbackEnabled = parseBool(inArg.fallback) || false; // 默认为false
...
function buildBaseLists({ landing, lowCost, countryInfo, fallbackEnabled }) {
    ...
    const selector = [];
    if (fallbackEnabled) selector.push("故障转移"); // 根据参数决定是否添加故障转移
...
const ruleProviders = {
    ...
    "Emby": {
        "type": "http", "behavior": "classical", "format": "text", "interval": 86400,
        "url": "https://gist.githubusercontent.com/River-1024/38025afaa35a3366dc1c77d2d71507d6/raw/Emby.list",
        "path": "./ruleset/Emby.list"
    },
    "DIY-zhi": {
        "type": "http", "behavior": "classical", "format": "text", "interval": 86400,
        "url": "https://gist.githubusercontent.com/River-1024/38025afaa35a3366dc1c77d2d71507d6/raw/DIY-zhi.list",
        "path": "./ruleset/DIY-zhi.list"
    },
    "DIY-Proxy": {
        "type": "http", "behavior": "classical", "format": "text", "interval": 86400,
        "url": "https://gist.githubusercontent.com/River-1024/38025afaa35a3366dc1c77d2d71507d6/raw/DIY-Proxy.list",
        "path": "./ruleset/DIY-Proxy.list"
    },
    "GitHub": {
        "type": "http", "behavior": "classical", "format": "text", "interval": 86400,
        "url": "https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@master/rule/Loon/GitHub/GitHub.list",
...
function buildProxyGroups({
    ...
    return [
        ...
        {
            "name": "Emby",
            "icon": "https://cdn.jsdelivr.net/gh/lige47/QuanX-icon-rule@main/icon/lj-emby.png",
            "type": "select",
            "proxies": defaultProxies
        },
...
function main(config) {
    ...
    } = buildBaseLists({ landing, lowCost, countryInfo, fallbackEnabled });
